"""
Simplified training script for Shakespeare character-level training on single GPU.
Hardcoded configuration for Shakespeare character-level language modeling.
...
device_type = 'cuda' # always cuda for single GPU
...
while True:
    ...
    if iter_num % log_interval == 0:
        ...
        print(f"iter {iter_num}: loss {lossf:.4f}, a1 {model.a1.item():.4f}, a2 {model.a2.item():.4f}, time {dt*1000:.2f}ms, mfu {running_mfu*100:.2f}%")
    iter_num += 1
    local_iter_num += 1
